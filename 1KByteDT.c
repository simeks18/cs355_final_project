...
printf("\n--- Testing set_specific_bit ---\n");
    printf("Setting bit 10 in array A:\n");
    set_specific_bit(array_A, 10);
    printf("Array A: ");
    printinHex(array_A);

printf("Setting bit 20 in array B:\n");
    set_specific_bit(array_B, 20);
    printf("Array B: ");
    printinHex(array_B);
...
printf("\n--- Testing clear_bit ---\n");
    printf("Clearing bit 10 from the result array:\n");
    clear_bit(result_array, 10);
    printf("Result: ");
    printinHex(result_array);
